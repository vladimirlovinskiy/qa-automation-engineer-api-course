...
class ExercisesClient(APIClient):
    ...
    def get_exercises_api(self, query: GetExercisesQuerySchema) -> Response:
        ...
        Args:
            query (GetExercisesQuerySchema): Словарь с courseId
    ...
    def create_exercise_api(self, request: CreateExerciseRequestSchema) -> Response:
        ...
        Args:
            request (CreateExerciseRequestSchema): Словарь с title, courseId, maxScore, minScore, orderIndex, description, estimatedTime
    ...
    def update_exercise_api(self, exercise_id: str, request: UpdateExerciseRequestSchema) -> Response:
        ...
        Args:
            exercise_id (str): Идентификатор задания.
            request (UpdateExerciseRequestSchema): Словарь с title, maxScore, minScore, orderIndex, description, estimatedTime
